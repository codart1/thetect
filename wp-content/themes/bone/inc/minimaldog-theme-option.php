<?php
    ...
    // Article color
    $primary_color_output .=    '.postFormatBadge,.comment-author, .postMeta--author-author a,.postFormatQuote:before,.logged-in-as a:first-child,.menu--offCanvas li.current-menu-item > a,.siteFooter-copyright a';
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'default'  => '2016 &copy; <a href="http://minimaldog.net">minimaldog theme</a>'
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'subtitle' => 'Define how to get posts for featured block',
                'options'  => array(
            ...
            array(
                ...
                'subtitle' => esc_html__('Toggle More reading by category section', 'bone'),
                'default'  => false,
            ),
            array(
